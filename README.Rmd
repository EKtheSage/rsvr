...
9. We save our final reserves numbers and any relevant data, documentation into a historical database for future reference
10. Based on the historical database, we create tools to monitor the portfolio
    - Include metrics such as Actual vs Expected, reported frequency, reported severity, etc
